...
const Logo = () => (
  ...
  >
    <div className="relative flex items-center">
      <div className="w-8 h-8 text-alanizGold-600 group-hover:text-alanizGold-500 
                      transition-colors duration-300 drop-shadow-gold flex items-center justify-center text-xl">
        🛡️
      </div>
      <div className="absolute inset-0 bg-alanizGold-600/20 rounded-full scale-0 
                      group-hover:scale-150 transition-transform duration-500 -z-10"></div>
    </div>
    <div className="hidden lg:flex flex-col justify-center">
      <h1 className="text-xl font-display font-bold text-alanizGold-600 
      ...
      <>
        ...
        {isActive && (
          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 
                          w-6 h-0.5 bg-alanizGold-600 rounded-full"></div>
        )}
        <div className="absolute inset-0 bg-alanizGold-600/10 rounded-lg scale-0 
                        group-hover:scale-100 transition-transform duration-300 -z-10"></div>
      </>
    )}
  </NavLink>
);
