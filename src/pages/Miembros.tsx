...
export default function Miembros() {
  ...
  const handleLogout = () => {
    ...
    if (
      window.confirm(
        "¿Está seguro de que desea cerrar la sesión y salir del área privada?"
      )
    ) {
        ...
        <div className="content-container">
          ...
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-lg text-parchment-300 max-w-3xl mx-auto leading-relaxed">
              Has accedido al área privada de la Casa Alaniz. Desde aquí podrás
              gestionar los documentos sagrados y registros históricos de
              nuestra noble casa.
            </p>
          </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <p className="text-parchment-200">
                          <strong className="text-alanizGold-600">
                            Usuario:
                          </strong>{" "}
                          {sessionInfo.user}
                        </p>
                        <p className="text-parchment-200">
                          <strong className="text-alanizGold-600">Rol:</strong>{" "}
                          {sessionInfo.role}
                        </p>
                        <p className="text-parchment-200">
                          <strong className="text-alanizGold-600">
                ...
                <div className="text-center space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-parchment-200 leading-relaxed max-w-2xl mx-auto">
                      ...
                      . Aquí se custodiarán los documentos sagrados y registros
                      históricos de la Casa Alaniz.
                    </p>
                  </div>
              ...
              >
                ...
                <div className="mt-4 p-3 bg-alanizGreen-900/30 rounded-lg border border-alanizGold-600/20">
                  <p className="text-xs text-parchment-400 text-center italic">
                    "El conocimiento preservado es el tesoro más valioso de una
                    casa noble"
                  </p>
                </div>
              </div>
