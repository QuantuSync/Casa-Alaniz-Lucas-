  ...
  return (
    <div className="min-h-screen bg-alanizGreen-950">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-alanizGold-600/3 rounded-full blur-2xl animate-float" 
      ...
      <div className="relative z-10 py-16">
        <div className="content-container">
          ...
          <div className="text-center mb-16 animate-fade-in-up">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-alanizGold-600 
                            rounded-full shadow-2xl mb-8 animate-float">
              <span className="w-10 h-10 text-alanizGreen-950 text-3xl">🛡️</span>
            </div>
            ...
            <p className="text-lg text-parchment-300 max-w-3xl mx-auto leading-relaxed">
              Has accedido al área privada de la Casa Alaniz. Desde aquí podrás gestionar 
              los documentos sagrados y registros históricos de nuestra noble casa.
            </p>
          </div>
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div className="flex-1 space-y-4">
                    <div>
                      ...
                      <div className="space-y-2">
                        <p className="text-parchment-200">
                          <strong className="text-alanizGold-600">Usuario:</strong> {sessionInfo.user}
                        </p>
                        <p className="text-parchment-200">
                    ...
                    <div className="flex items-center space-x-2 text-sm">
                      ...
                      <span className="text-parchment-400">{currentTime.toLocaleTimeString('es-ES')}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card-elegant animate-fade-in-up" style={{ animationDelay: '400ms' }}>
                <div className="text-center space-y-6">
                  <div className="inline-flex items-center justify-center w-16 h-16 
                    ...
                    <span className="w-8 h-8 text-alanizGold-600 text-2xl">📚</span>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-parchment-200 leading-relaxed max-w-2xl mx-auto">
                      Acceso confirmado como <strong className="text-alanizGold-600">{sessionInfo.user}</strong>.
                      Aquí se custodiarán los documentos sagrados y registros históricos de la Casa Alaniz.
                    </p>
                  </div>
                  ...
                  <div className="mt-8">
                    ...
                    <div className="grid gap-4">
                      {availableFeatures.map((feature, index) => {
                        return (
                          <div key={feature.title} className="flex items-center space-x-4 p-4 
                            ...
                            <span className="text-xs text-alanizGold-600/70 bg-alanizGold-600/10 
              ...
              <div className="card-elegant animate-fade-in-up" style={{ animationDelay: '800ms' }}>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="w-4 h-4 text-alanizGold-600">⏰</span>
                    <span className="text-parchment-300">
                      Tiempo de sesión: {Math.floor((Date.now() - sessionInfo.loginTime.getTime()) / 60000)} min
                    </span>
                  </div>
                </div>
